...
namespace filmdizikitap.Controllers
{
    public class CategoryController : Controller
    {
        ...
        {
            var kategoriler = db.Kategoriler.Select(i => new CategoryModel() { KategoriAdi = i.KategoriAdi, Id = i.Id, BlogSayisi = i.Bloglar.Count() }).OrderBy(i => i.KategoriAdi);
            return View(kategoriler.ToPagedList(page ?? 1, 5));
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,KategoriAdi")] CategoryModel category)
        {
            if (ModelState.IsValid)
            {
